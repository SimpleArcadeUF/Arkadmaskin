...
class MenuState(State.State):
    def __init__(self):
        ...
        self.B_START.alignVertically(self.Sub_frame_top, Arcade.ALIGN_TOP)
        ...
        self.B_QUIT.alignHorizontally(self.Sub_frame_top, Arcade.ALIGN_CENTER)
        self.B_QUIT.alignVertically(self.Sub_frame_top, Arcade.ALIGN_BOTTOM)
        ...
        self.Sub_frame_top.attachGui(self.B_QUIT)
